 ...
 * Scheduled for Today at 14:23 (2:23 PM) until 14:53 (2:53 PM).
 */
...
async function setup() {
  try {
    ...
    // FECHA: Hoy a las 14:23
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0];
    const startsAt = `${dateStr} 14:23:00-04`;
    const endsAt = `${dateStr} 14:53:00-04`;

    console.log(`Creando cita para las 14:23 (2:23 PM)...`);
    ...
    const insertQ = `
      INSERT INTO cita (
        ...
        $3, $4, 30, 1500, NOW(),
        'virtual', 'Consulta Programada 2:23 PM (Zego Web Test)', 'confirmada'
      ) RETURNING citaid
    `;
