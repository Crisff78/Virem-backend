...
async function run() {
  try {
    console.log('--- Configurando Cita 12:50 PM ---');
    ...
    // 3. Create a NEW appointment at 12:50 PM
    // We use -04 for the timezone as per the previous script example
    const start = '2026-05-07 12:50:00-04';
    const end = '2026-05-07 13:20:00-04';
    ...
    const insertQ = `
      INSERT INTO cita (
        ...
        $3, $4, 30, 1000, NOW(),
        'virtual', 'Consulta Programada 12:50', 'pendiente'
